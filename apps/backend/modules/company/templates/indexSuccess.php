...
<div id="sf_admin_container">
  <h1><?php echo __('Список компаний', array(), 'messages') ?></h1>
  ...
  <div id="sf_admin_content">
    ...
    <?php include_partial('company/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper, 'configuration' => $configuration)) ?>
