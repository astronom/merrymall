...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_bar">
    <?php include_partial('s_category/filters', array('form' => $filters, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('s_category_collection', array('action' => 'batch')) ?>" method="post">
    <?php include_partial('s_category/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper, 'sortedCategories' => $sortedCategories)) ?>
