<?php slot('title',sprintf('%s компании %s | Акции | Мерри Молл', $companyType, $company->getName()))?>
                    ...
                    <div class="content">
                      ...
                      <div class="company-content">
                        ...
                        <div class="company-content-text">
                          ...
                          <div class="text">
                          	<?php echo image_tag($actionsItem->getLogoUrl(), array())?>
                            <a href="<?php echo url_for('company_show_actions', $actionsItem) ?>"><?php echo $actionsItem->getTitle() ?></a>
                          </div>
