...
class sfGuardRouting
{
  ...
  static public function listenToRoutingLoadConfigurationEvent(sfEvent $event)
  {
    ...
    $r->prependRoute('sf_guard_register', new sfRoute('/registration', array('module' => 'sfGuardRegister', 'action' => 'register')));
    $r->prependRoute('sf_guard_confirm', new sfRoute('/registration/confirm/:guid', array('module' => 'sfGuardRegister', 'action' => 'confirm')));
  }
