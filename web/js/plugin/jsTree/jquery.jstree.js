	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				...
				'.jstree > ul > li { margin-left:0px; margin-top:7px; } ' + 
				'.jstree-rtl > ul > li { margin-right:0px; } ' + 
				'.jstree ins { display:inline-block; text-decoration:none; width:18px; height:18px; margin:0 0 0 0; padding:0; } ' + 
				'.jstree a { display:inline-block; /*line-height:16px; height:16px;*/ color:black; white-space:normal; text-decoration:none; padding:1px 2px; margin:0; } ' + 
